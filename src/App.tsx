                ...
                <article className="max-w-xl flex-col items-start">
                  ...
                  <div className="group relative">
                    ...
                    <h3 className="mt-3 text-lg font-semibold leading-6 text-gray-900 group-hover:text-gray-600">
                      <a href="google.com">Calculator: Is My Startup Viable?</a>
                    </h3>
                    <ul className="mt-5 text-sm leading-6 text-gray-600 custom-bullets text-left">
                      ...
                      <li>
                        Jason is "a four-time entrepreneur across 23 years, both
                        bootstrapped and VC-funded, resulting in two exits and
                        two unicorns."
                      </li>
                      <li>
                        I walked away from my most recent revenue-generating
                        startup after analyzing my target audience, business
                        model, and product using this calculator.
                      </li>
                    </ul>
                  </div>
                </article>
